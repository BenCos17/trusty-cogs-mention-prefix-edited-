...
insults: List[str] = [
    ...
    _("Youâ€™re so ugly you can be a modern art master piece"),
    ...
    _("Donâ€™t feel bad, there are many people who have no talent!"),
    _("Iâ€™d like to kick you in the teeth, but why should I improve your looks?"),
    _(
        "At least thereâ€™s one thing good about your body, itâ€™s not as ugly as your face."
    ),
    _("Brains arenâ€™t everything. In fact, in your case theyâ€™re nothing."),
    _("If I had a face like yours Iâ€™d sue my parents."),
    _("Donâ€™t think, it might sprain your brain."),
    _("Are you always so stupid or is today a special occasion?"),
    _("You are the living proof that man can live without a brain."),
    _("I donâ€™t know what it is that makes you so stupid but it really works."),
    ...
    _("Please shut your mouth when youâ€™re talking to me."),
    _(
    ...
    _("You look like a â€˜beforeâ€™ picture for an antidepressant."),
